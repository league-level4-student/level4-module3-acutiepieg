...
//		}
	...
	public void testReverseString() {
		try {
			System.out.println(ExceptionMethods.reverseString("hello"));
			System.out.println(ExceptionMethods.reverseString(""));
			System.out.println(ExceptionMethods.reverseString("hola"));
		}catch(IllegalStateException e) {
			System.out.println("There was an empty string");
		}
	}
